...
- [ ] 3. Implement Morning Briefing 5-part flow
  - [ ] 3.1 Create MorningBriefingScreen with time-based access control
  ...
  - [ ] 3.2 Implement Part 1: Morning greeting with quote
  ...
  - [ ] 3.3 Implement Part 2: Yesterday's recap
  ...
  - [ ] 3.4 Implement Part 3: Suggested lessons
  ...
  - [ ] 3.5 Implement Part 4: Daily intention input
  ...
  - [ ] 3.6 Implement Part 5: Rex personalized message
...
- [ ] 4. Implement Evening Debrief 4-part flow
  - [ ] 4.1 Create EveningDebriefScreen with time-based access control
  ...
  - [ ] 4.2 Implement Part 1: Day rating
